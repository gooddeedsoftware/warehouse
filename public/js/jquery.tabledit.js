            ...
            columns: {
                identifier: function() {
                    ...
                    $td.each(function() {
                        ...
                        var input = '<input class="tabledit-input tabledit-identifier" id="'+$(this).attr("id")+'" type="hidden" name="' + settings.columns.identifier[1] + '" value="' + $(this).text().trim() + '" disabled>';
                    ...
                    for (var i = 0; i < settings.columns.editable.length; i++) {
                        ...
                        $td.each(function() {
                            ...
                            if (typeof settings.columns.editable[i][2] !== 'undefined') {
                                ...
                                var input = '<select  id="'+$(this).attr("data-id")+'" class="tabledit-input ' + settings.inputClass + '" name="' + settings.columns.editable[i][1] + '" style="display: none;" disabled>';
                                ...
                                var input = '<input  id="'+$(this).attr("data-id")+'" class="tabledit-input ' + settings.inputClass + '" type="text" name="' + settings.columns.editable[i][1] + '" value="' + text + '" style="display: none;" disabled>';
                            }
