...
<div class="PageClass">
    <div class="showLast" style="height: 80px">
     <table class="table table-sm table-bordered" style='font-size: 13px !important;'>
        <thead>
            <tr style="background-color: lightgrey !important; font-style:italic !important">
                <th width="15%">{{ __('report.mottatt') }}</th>
                <th width="15%">{{ __('report.dato') }}</th>
                <th width="15%">{{ __('report.kolli') }}</th>
                <th width="15%">{{ __('report.pakket') }}</th>
                <th width="15%">{{ __('report.kontrollert') }} </th>
                <th width="15%">{{ __('report.delivery_date') }} </th>
            </tr>
        </thead>
        <tbody>
            <tr>
